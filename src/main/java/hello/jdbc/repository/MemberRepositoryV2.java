...
public class MemberRepositoryV2 {
    ...
    /**
     * 계좌이체 서비스 로직에서 호출하는 메서드
     * 커넥션 유지 필요
     */
    public Member findMember(Connection con, String memberId) throws SQLException {
        String sql = "select * from member where member_id = ?";
        ...
        try {
            ...
            /**
             * 커넥션 유지가 필요한 메서드로 리포지토리에서 커넥션을 닫으면 안된다.
     ...
     * 커넥션 유지 필요
     */
    public void updateMember(Connection con, String memberId, int money) throws SQLException {
        String sql = "update member set money = ? where member_id = ?";
